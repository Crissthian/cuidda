                ...
                examenes: [
                    {
                        ...
                        numero_examen: 19,
                        descripcion:
                            "Electrocardiograma (EKG) Reposo 12 Derivaciones",
                        orden: 1,
                    },
                    {
                        id_examen: 3004,
                ...
                examenes: [
                    {
                        ...
                        numero_examen: 25,
                        descripcion:
                            "Radiografía de Columna Cervical Frontal y Lateral",
                        orden: 1,
                    },
                    {
                        id_examen: 5002,
...
export const archivosMock: ArchivoConsulta[] = [
    {
        ...
        descripcion:
            "Placa de tórax PA OIT con informe de neumoconiosis negativo",
    ...
    },
    {
        ...
        descripcion:
            "Trazado de EKG en reposo sin arritmias ni signos de isquemia",
