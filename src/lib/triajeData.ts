...
export const catalogosTriajeMock: CatalogosTriaje = {
  ...
  medicos: [
    { cdg_med: "001", des_med: "DR. CARLOS PEREZ GOMEZ", cod_med: "CMP-12345" },
    { cdg_med: "002", des_med: "DRA. ROSA FLORES DIAZ", cod_med: "CMP-23456" },
    { cdg_med: "003", des_med: "DR. MIGUEL TORRES VEGA", cod_med: "CMP-34567" },
  ],
  procedencia: [
