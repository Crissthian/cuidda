          ...
          >
            ...
            <div className="overflow-y-auto px-8 py-6">
              ...
              <p className="mt-1 text-sm text-accent-muted">
                El cambio quedará registrado con datos originales, datos
                modificados, usuario y fecha.
              </p>
              ...
              >
                <div>
                  <label htmlFor="edicion-expuestos" className={labelClass}>
                  ...
                  <input
                    ...
                    type="text"
                    value={expuestos}
                    onChange={(e) => setExpuestos(e.target.value)}
                    className={inputClass}
                    autoComplete="off"
                  />
                </div>
                <div>
                  <label htmlFor="edicion-observacion" className={labelClass}>
