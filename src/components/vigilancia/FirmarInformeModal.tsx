          ...
          >
            ...
            <div className="overflow-y-auto px-8 py-6">
              ...
              <p className="mt-1 text-sm text-accent-muted">
                Al firmar, el informe queda bloqueado. Para modificarlo deberá
              ...
              >
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="firma-nombres" className={labelClass}>
                      Nombres y Apellidos
                    </label>
                    <input
                      id="firma-nombres"
                  ...
                  <div>
                    <label htmlFor="firma-documento" className={labelClass}>
                  ...
                  <div>
                    <label htmlFor="firma-cargo" className={labelClass}>
                      Cargo
                    </label>
                    <input
                      id="firma-cargo"
                  ...
                  <div>
                    <label htmlFor="firma-cmp" className={labelClass}>
                ...
                <p className="text-xs leading-relaxed text-risk-salmon">
                  Según la configuración de la empresa, el informe puede
                  presentarse únicamente con la firma médica.
                </p>
