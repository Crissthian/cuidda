      ...
      >
        ...
        <div className="divide-y divide-dashed divide-border-subtle">
          {filas.map((f) => (
            ...
            >
              <span role="cell" className="pr-2 text-xs text-text-primary">
                {f.categoria}
              </span>
              <span role="cell" className="text-center text-xs text-muted">
                {f.m1829}
              </span>
              <span role="cell" className="text-center text-xs text-muted">
                {f.f1829}
...
export default function InformeRegulatorioDetalleContent({ informe }: Props) {
  ...
  const actualizarConclusion = (index: number, valor: string) => {
    setConclusiones((prev) => prev.map((c, i) => (i === index ? valor : c)));
  };
  ...
  const actualizarRecomendacion = (index: number, valor: string) => {
    setRecomendaciones((prev) => prev.map((r, i) => (i === index ? valor : r)));
  };
  ...
  return (
    <div className="flex flex-col gap-5 px-10 pb-6 text-xs">
      ...
      >
        <span className="w-2 shrink-0 bg-risk-red" aria-hidden="true"></span>
        <div className="flex flex-1 items-start gap-4 px-6 py-5">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-sm leading-relaxed text-text-primary">
              {informe.observaciones} observación(es) de consistencia deben
              resolverse o justificarse antes de la firma.
            </p>
            <a
              href="#auditoria"
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted">
              Distribución epidemiológica calculada desde fecha de nacimiento,
              sexo, diagnóstico y fecha de EMO.
            </p>
          </div>
          <ToggleVista
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted">
              Solo se incluyen diagnósticos con clasificación previamente
              validada por el médico ocupacional.
            </p>
          </div>
          <ToggleVista
      ...
      >
        ...
        <p className="mt-0.5 text-xs text-muted">
          Agrupadas por grupo de agente de exposición. La población expuesta
          proviene del GES / matriz de riesgos.
        </p>
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted">
              Textos redactados automáticamente con cifras provenientes de la
              base de datos. Editables por el médico.
            </p>
          </div>
          <button
            type="button"
          ...
          >
            <i className="fa-solid fa-robot text-[11px]" aria-hidden="true" />
            REGENERAR CON IA
          </button>
        </div>
        ...
        <div className="mt-2 flex flex-col gap-2">
          {conclusiones.map((c, i) => (
            ...
            >
              ...
              <textarea
                value={c}
                onChange={(e) => actualizarConclusion(i, e.target.value)}
        ...
        <div className="mt-2 flex flex-col gap-2">
          {recomendaciones.map((r, i) => (
            ...
            >
              ...
              <textarea
                value={r}
                onChange={(e) => actualizarRecomendacion(i, e.target.value)}
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-0.5 text-xs text-muted">
            Firma del médico responsable y del representante autorizado de la
            empresa.
          </p>
          <p className="mt-4 text-xs text-muted">Sin firmas registradas.</p>
        </section>
