...
export default function CargarDescansosModal({ isOpen, onClose }: Props) {
    ...
    <>
      {isOpen && !showSuccess && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="modal-descansos-title"
          ...
          >
            ...
            <div className="overflow-y-auto px-8 py-8">
              ...
              <section
                ...
                aria-labelledby="archivo-fuente-descansos-title"
              >
                <h3
                  id="archivo-fuente-descansos-title"
                  className="text-sm font-bold text-brand"
                >
                  Archivo fuente
                </h3>
                <p className="text-xs text-muted">Formatos aceptados: PDF</p>
