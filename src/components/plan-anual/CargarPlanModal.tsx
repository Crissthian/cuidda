...
export default function CargarPlanModal({ isOpen, onClose }: Props) {
  ...
  const handleDownload = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Plan Anual");

    XLSX.writeFile(workbook, "PLAN_ANUAL_UNACEM_2026.xlsx");
  };
