    ...
    >
      <div className="flex items-center gap-2">
        <span
          ...
          aria-hidden="true"
        >
          <i className={`fa-solid ${icon} text-sm text-white-custom`} />
        </span>
        <h2 id={id} className="flex-1 text-sm font-medium text-text-primary">
          {title}
        </h2>
        {downloadLabel && (
          <button
  ...
  return (
    <div className="flex flex-1 flex-col rounded-lg bg-surface-default p-3 shadow shadow-border-default">
      ...
      <div className="mt-4 flex items-end justify-center gap-2">
        {items.map((item) => (
          <div key={item.id} className="flex w-20 flex-col items-center">
            <div
...
function CategoriaChart({
  ...
  return (
    <div className="flex flex-1 flex-col rounded-lg bg-surface-default shadow shadow-border-default p-3">
      {title && <SubChartHeader title={title} label={downloadLabel ?? title} />}
  ...
  return (
    <div className="flex flex-col gap-5 text-xs">
      ...
      <div className="flex flex-col gap-5 pb-4">
        ...
        {/* ── Medicina ── */}
        <SectionCard id="medicina" title="Medicina" icon="fa-briefcase-medical">
        ...
        {/* ── Laboratorio ── */}
        <SectionCard id="laboratorio" title="Laboratorio" icon="fa-flask-vial">
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <SectionCard id="espirometria" title="Espirometría" icon="fa-lungs">
            <div className="flex items-start justify-end">
              <button
                type="button"
        ...
        {/* ── Oftalmología ── */}
        <SectionCard id="oftalmologia" title="Oftalmología" icon="fa-eye">
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-3">
              <DistribucionBarras
