  ...
  return (
    <div className="flex flex-col">
      <div className="grid grid-cols-[3rem_2fr_1fr_1fr_2fr_1fr_1fr_0.5fr] gap-2 items-center text-sm p-2 border-b border-dashed border-border-default">
        ...
        <div className="text-center uppercase text-ms text-text-secondary">
          {archivo.subidoPor}
        </div>
        <div className="text-center uppercase text-ms text-text-secondary">
          {archivo.descripcion}
        </div>
        <div className="text-center text-ms text-text-secondary">
...
export default function ArchivosTab({
  ...
  const onSave = () => {
    ...
    const existeNombre = archivos.some(
      (archivo) => archivo.nombre.toLowerCase() === nombreFinal.toLowerCase(),
    );
    if (existeNombre) {
      setGeneralError(
        "Ya existe un archivo con este nombre. Por favor, elige otro.",
      );
      return;
    }
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p className="text-text-primary text-sm leading-relaxed">
              Esta acción es irreversible. El archivo se eliminará
              permanentemente de la consulta médica.
            </p>
