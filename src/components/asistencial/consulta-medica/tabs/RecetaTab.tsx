...
export default function RecetaTab({ readOnly = false }: RecetaTabProps) {
  ...
  useEffect(() => {
    ...
    debounceTimerReceta.current = setTimeout(() => {
      ...
      const res = medicamentosMock.filter((m) =>
  ...
  const autocompletarCIE10 = (
    ...
    const encontrado = catalogoCIE10Mock.find(
          ...
          <div className="rounded-lg overflow-hidden">
            ...
            <div>
              {diagnosticos.map((field, index) => {
                const diagnosticosErrors = errors?.diagnosticos as
                  ...
                  <Fragment key={field.id}>
                    <div
                      ...
                      style={{
                        display: "grid",
                        gridTemplateColumns:
                          "120px 1fr 360px 40px 40px 40px 150px",
                      }}
                    >
