...
export default function ModalConsultaMedica({
  ...
  const [sedes, setSedes] = useState<{ des_item: string; num_item: string }[]>(
    [],
  );
  ...
  const modoEdicion =
    methods.watch("modoEdicion") || (estado === "2" ? "actualizar" : "crear");
  const razonSocial =
  ...
  useEffect(() => {
    ...
    if (pac) {
      ...
      methods.setValue("frecuenciaCardiaca", pac.frecuenciaCardiaca || "72");
      methods.setValue("presionSistolica", pac.presionSistolica || "120");
      methods.setValue("presionDiastolica", pac.presionDiastolica || "80");
      methods.setValue("saturacionOxigeno", pac.saturacionOxigeno || "98");
      methods.setValue("modoEdicion", estado === "2" ? "actualizar" : "crear");
    }
  ...
  return (
    ...
    >
      <FormProvider {...methods}>
        {errorInput && <p className="text-red-500 mb-4">{errorInput}</p>}
        <form
          ...
          <div>
            ...
            <div className="mb-4 p-4">
              ...
              <div className="grid grid-cols-12 gap-4">
                <div className="flex flex-col col-span-4">
                  <label className="form-label" htmlFor="nombresApellidos">
                    Nombres y Apellidos
                  </label>
                  <input
                    type="text"
                    ...
                    {...methods.register("nombresApellidos")}
                  />
                </div>
            ...
            <div className="rounded-lg shadow-lg p-4 mx-4 text-sm">
              <div className="text-center">
                <div
                  className={
                    activeTab === "datos-generales" ? "block" : "hidden"
                  }
                >
                  <DatosGeneralesTab
                    onExamenesAuxiliaresLoaded={handleExamenesAuxiliaresLoaded}
                    readOnly={isReadOnlyMode}
                  />
                </div>
                <div
                  className={activeTab === "examen-medico" ? "block" : "hidden"}
                >
                  <ExamenMedicoTab
                ...
                <div className={activeTab === "receta" ? "block" : "hidden"}>
                  <RecetaTab
                ...
                <div
                  className={activeTab === "examenes-aux" ? "block" : "hidden"}
                >
                  <ExamenesAuxiliaresTab
                    estado={estado}
                    codigoAtencion={codigoAtencionActual}
                    selectedExamenes={examenesSeleccionados}
                    onSelectionChange={setExamenesSeleccionados}
                    readOnly={isReadOnlyMode}
                  />
                </div>
                <div
                  className={activeTab === "referencia" ? "block" : "hidden"}
                >
                  <Referencia
                    codigoAtencion={codigoAtencionActual}
                    estado={estado}
