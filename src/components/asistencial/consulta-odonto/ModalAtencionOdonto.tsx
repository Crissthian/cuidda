            ...
            try {
                ...
                if (refConsultaTab.current) {
                    const consultaValida =
                        await refConsultaTab.current.validate();
                    if (!consultaValida) {
                        toast.error(
                            "Complete los datos obligatorios de la consulta",
                        );
                ...
                setTimeout(() => {
                    setCodigoOdontologia(
                        datosEvento.codigoOdontologia || "00000015",
                    );
