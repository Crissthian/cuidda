 ...
 */
export const handleRestauracionTemporalClick = (ctx: ClickHandlerContext, surface?: string): boolean => {
	...
	const existing = hallazgos.find((h) => h.hallazgo === 'RESTAURACION_TEMPORAL' && h.diente === id)
