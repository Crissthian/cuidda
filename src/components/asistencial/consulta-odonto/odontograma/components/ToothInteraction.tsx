...
export const ToothInteraction: FC<ToothInteractionProps> = ({
  ...
  const getZoneProps = (zone: string) => {
    ...
    const isRestauracionTemporal =
      restauracionTemporal?.surfaces.includes(zone);
      ...
      {pulpotomia && (
        ...
        >
          <div
            ...
            style={{
              backgroundColor:
                pulpotomia.status === "bueno" ? "#2563eb" : "#dc2626",
            }}
          ></div>
        </div>
      )}
      {tratamientoConducto && (
        ...
        >
          <div
            ...
            style={{
              backgroundColor:
                tratamientoConducto.status === "bueno" ? "#2563eb" : "#dc2626",
            }}
          ></div>
        </div>
      )}
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20 border border-transparent">
          <div className={`relative w-8 h-8 flex items-center justify-center`}>
            <div
              ...
              style={{
                backgroundColor:
                  sellante.status === "bueno" ? "#2563eb" : "#dc2626",
              }}
            ></div>
            <div
