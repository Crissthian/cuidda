...
const colorClasses = {
	blue: {
		...
		itemNeutral: 'text-text-primary hover:bg-surface-light border-border-default'
	},
	red: {
...
export const ToolbarDropdownMenu: React.FC<ToolbarDropdownMenuProps> = ({
	...
	const getItemVariantClass = (variant: 'bueno' | 'malo' | 'neutral' = 'neutral') => {
		switch (variant) {
			case 'bueno':
				...
				>
					<div className='p-2'>
						...
						{sections.map((section, sectionIndex) => (
							<div
								key={sectionIndex}
								className={sectionIndex > 0 ? 'mt-2 pt-2 border-t border-border-subtle/40' : ''}
							>
								{section.title && (
									<div
