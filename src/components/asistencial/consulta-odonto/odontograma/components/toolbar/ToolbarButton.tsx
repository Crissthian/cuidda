...
export const ToolbarButton: React.FC<ToolbarButtonProps> = ({
  ...
  const variants = {
    bueno:
      "bg-white border-blue-200 text-blue-700 hover:bg-blue-50 focus:ring-blue-500",
    malo: "bg-white border-red-200 text-red-700 hover:bg-red-50 focus:ring-red-500",
    neutral:
      "bg-white border-gray-200 text-gray-700 hover:bg-gray-50 focus:ring-gray-400",
