 ...
 */
export const OdontogramaSvgOverlay = React.memo<OdontogramaSvgOverlayProps>((props) => {
	const baseProps = {
	...
	return (
		<svg className='absolute top-0 left-0 w-full h-full pointer-events-none z-10'>
			<EdentulousOverlay hallazgos={props.hallazgos} viewMode={props.viewMode} {...baseProps} />
			...
			<PiezaAusenteOverlay piezasAusentes={props.piezasAusentes} {...baseProps} />

			<DienteEnClavijaOverlay dientesEnClavija={props.dientesEnClavija} {...baseProps} />

			<PiezaErupcionOverlay piezasErupccion={props.piezasErupccion} {...baseProps} />

			<PiezaExtruidaOverlay piezasExtruidas={props.piezasExtruidas} {...baseProps} />

			<PiezaIntruidaOverlay piezasIntruidas={props.piezasIntruidas} {...baseProps} />

			<PiezaSupernumerariaOverlay piezasSupernumerarias={props.piezasSupernumerarias} {...baseProps} />

			<ProtesisFijaOverlay protesisFija={props.protesisFija} {...baseProps} />

			<ProtesisTotalOverlay hallazgos={props.hallazgos} viewMode={props.viewMode} {...baseProps} />

			<ProtesisRemovibleOverlay hallazgos={props.hallazgos} viewMode={props.viewMode} {...baseProps} />

			<TransposicionOverlay transposiciones={props.transposiciones} {...baseProps} />
		</svg>
	)
})
