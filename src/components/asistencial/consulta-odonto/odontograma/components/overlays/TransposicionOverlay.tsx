	...
	return (
		<>
			...
			{transposiciones.map((trans) => {
				if (!isToothInCurrentView(trans.startId, upperTeeth, lowerTeeth)) return null
				...
				const offset = isUpper ? VERTICAL_OFFSETS.upper.siglaImageSpace : VERTICAL_OFFSETS.lower.siglaImageSpace
