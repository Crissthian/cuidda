...
const NumberBox: React.FC<{
	...
	const labelConfigs = [
		...
		},
		{
			...
			label: 'PP',
			colorClass: pulpotomia?.status === 'bueno' ? 'text-blue-600 border-blue-600' : 'text-red-600 border-red-600'
		},
		{
			condition: !!crown,
			label: crown?.label || '',
			colorClass: crown?.status === 'bueno' ? 'text-blue-600 border-blue-600' : 'text-red-600 border-red-600'
		},
		{
			condition: !!restauracion,
			label: restauracion?.sigla || '',
			colorClass:
				restauracion?.status === 'bueno' ? 'text-blue-600 border-blue-600' : 'text-blue-600 border-red-600'
		},
		{
			condition: !!sellante,
			label: sellante?.sigla || '',
			colorClass: sellante?.status === 'bueno' ? 'text-blue-600 border-blue-600' : 'text-red-600 border-red-600'
		},
		{
			condition: !!caries,
			label: caries?.sigla || '',
		...
		},
		{
			...
			label: 'IMP',
			colorClass:
				implanteDental?.status === 'bueno' ? 'text-blue-600 border-blue-600' : 'text-red-600 border-red-600',
