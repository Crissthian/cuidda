			...
			items: [
				{
					...
					icon: Plus,
					variant: 'bueno',
					onClick: () => startSelection('pulpectomia' as SelectionType, 'bueno')
				},
				{
					id: 'pc-malo',
					label: 'Pulpectomía ',
		...
		},
		{
			...
			items: [
				...
				},
				{
					...
					label: 'Palatinizado',
					variant: 'bueno',
					onClick: () => startSelection('posicion_anormal_palatinizado', 'bueno'),
		...
		<div className='flex flex-col w-full gap-4 text-sm'>
				...
				<div className='flex items-center gap-4'>
					...
					{onDownload && (
						...
						>
							...
							<span>{isDownloading ? 'Descargando...' : 'Descargar captura'}</span>
						</button>
					)}
				</div>
			...
			<div className='bg-surface-light p-3 rounded-lg border border-border-default'>
				<div className='flex flex-wrap gap-2'>
					...
					<ToolbarDropdownMenu label='Caries' color='red' sections={cariesSections} />

					<ToolbarDropdownMenu label='Endodoncia' color='blue' sections={endodonciaSections} />

					<ToolbarDropdownMenu label='Prótesis' color='blue' sections={protesisSections} />
					{/* === ORTODONCIA === */}
					...
					<ToolbarDropdownMenu label='Ortodoncia' color='purple' sections={ortodonciaSections} />
					...
					<ToolbarDropdownMenu label='Fracturas/Anomalías' color='red' sections={fracturaSections} />

					<ToolbarDropdownMenu label='Piezas Ausentes' color='amber' sections={piezaAusenteSections} />

					<ToolbarDropdownMenu label='Posición Dentaria' color='green' sections={posicionDentariaSections} />

					<ToolbarDropdownMenu label='Hipoplasia del esmalte' color='red' sections={ddeSections} />
				</div>
			</div>
		</div>
	)
