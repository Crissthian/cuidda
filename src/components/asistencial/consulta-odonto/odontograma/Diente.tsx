 ...
 */
export const Diente: React.FC<DienteProps> = ({
  numero,
  x,
  y,
  filledFaces = {},
  ...
  const isUpper =
    (numero >= 11 && numero <= 28) || (numero >= 51 && numero <= 65);
  ...
  const rectY = isUpper
    ? -ROOT_H - 120 - RECT_H - MARGIN_VERTICAL
    : HEIGHT + ROOT_H + RECT_GAP + MARGIN_VERTICAL + 60;
