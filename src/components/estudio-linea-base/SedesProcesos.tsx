    ...
    return (
        ...
        >
            ...
            <p className="text-xs text-muted">
                Módulo sedes y procesos del sistema de vigilancia médica
                ocupacional CUIDDA.
            </p>
            <div className="mt-4 overflow-hidden rounded-lg">
                <div className="grid grid-cols-[1.2fr_0.7fr_0.6fr_0.8fr_1.2fr] gap-4 rounded-lg bg-surface-light p-3 text-[11px] font-semibold uppercase tracking-wider text-muted">
                    <span>Sede</span>
                    <span>Ubicación</span>
