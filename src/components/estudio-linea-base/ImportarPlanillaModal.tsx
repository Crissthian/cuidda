                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="font-normal text-text-secondary">
                                        Abre el archivo en Excel previamente
                                        descargado y completa la información.{" "}
                                        <span className="font-bold text-text-primary">
                                            IMPORTANTE:
                                        </span>{" "}
                                        Asegúrate de completar todas las
                                        columnas con la información requerida.
                                    </span>
                                </h3>
                            </section>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="text-xs text-muted">
                                        o selecciona desde tu equipo · hasta 20
                                        MB por archivo
                                    </p>
                                </div>
