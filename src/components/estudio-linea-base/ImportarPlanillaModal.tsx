...
export default function ImportarPlanillaModal({ isOpen, onClose }: Props) {
  ...
  const handleDownload = () => {
    ...
    worksheet["!cols"] = [{ wch: 32 }, { wch: 48 }];

    const workbook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(workbook, worksheet, "Planilla");

    XLSX.writeFile(workbook, "PLANILLA_FORMATO_2026.xlsx");
  };
    ...
    <>
      {isOpen && !showSuccess && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="modal-planilla-title"
          ...
          >
            ...
            <div className="overflow-y-auto px-8 py-8">
              ...
              <div className="text-center">
                <h2
                  id="modal-planilla-title"
                  className="text-xl font-bold text-brand"
                >
                  Documento Planilla de colaboradores
                </h2>
                <p className="mt-1 text-sm text-text-secondary">
                  Carga tu planilla en solo{" "}
              ...
              <section
                ...
                aria-labelledby="paso1-planilla-title"
              >
                <div className="flex items-center justify-between gap-4">
                  <h3
                    id="paso1-planilla-title"
              ...
              <section
                ...
                aria-labelledby="paso2-planilla-title"
              >
                <h3
                  id="paso2-planilla-title"
              ...
              <section
                className="mt-4 rounded-xl bg-surface-light p-5 shadow-md shadow-border-subtle/30 ring-1 ring-border-subtle/20"
                aria-labelledby="paso3-planilla-title"
              >
                <h3
                  id="paso3-planilla-title"
