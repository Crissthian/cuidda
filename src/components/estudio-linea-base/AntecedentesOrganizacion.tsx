  ...
  return (
    ...
    >
      ...
      <div className="mt-4 overflow-hidden rounded-lg">
        <div className="grid grid-cols-[1fr_1.5fr] gap-12 rounded-lg bg-surface-light p-3 text-[11px] font-semibold uppercase tracking-wider text-muted">
          <span>Campo</span>
          <span>Registro</span>
        </div>
        <div className="divide-y divide-dashed divide-border-subtle">
          {antecedentes.map((row) => (
            <div
              key={row.campo}
              className="grid grid-cols-[1fr_1.5fr] gap-12 p-3 text-xs"
            >
