...
export default function ActualizarProtocoloModal({ isOpen, onClose }: Props) {
        ...
        <>
            {isOpen && !showSuccess && (
                <div
                    ...
                    role="dialog"
                    aria-modal="true"
                    aria-labelledby="modal-actualizar-protocolo-title"
                    ...
                    >
                        ...
                        <div className="overflow-y-auto px-8 py-8">
                            ...
                            <div className="text-center">
                                <h2
                                    id="modal-actualizar-protocolo-title"
                            ...
                            >
                                <h3
                                    id="archivo-fuente-actualizar-title"
