...
export default function CargarProtocoloModal({ isOpen, onClose }: Props) {
  ...
  const handleDownload = () => {
    ...
    XLSX.writeFile(workbook, "PROTOCOLO_FORMATO_2026.xlsx");
  };
